...
const BentoCard = ({
    ...
    <div
        ...
        className={cn(
            ...
            // dark styles
            "transform-gpu dark:bg-black w-full border border-neutral-200 dark:border-neutral-800 dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
            className,
        )}
    >
        ...
        >
            <Button variant="ghost" asChild size="sm" className="pointer-events-auto cursor-pointer flex items-center gap-2 text-sm font-medium">
                <a href={href}>
                    {cta}
